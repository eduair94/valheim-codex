...
const SYSTEM = [
  ...
  '- Keep proper nouns of the game world in English: item, creature, biome,',
  '  boss, resource and structure names. A player reads "Iron Sword" and',
  '  "Black Forest" on their own screen, and translating them makes the article',
  '  useless for looking things up. Translate the words around them.',
